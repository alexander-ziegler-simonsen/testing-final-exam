import {
    missingStorageGetAllMedicationStorageMissings,
    missingStorageGet,
    missingStoragePost,
    missingStoragePut,
    missingStorageDelete,
} from '../api';
import {
    zHospitalApiDtosInputsMedicationStorageMissingInputDto,
} from '../api/zod.gen';
import type {
    HospitalApiDtosOutputsMedicationStorageMissingOutputDto,
    HospitalApiDtosInputsMedicationStorageMissingInputDto,
} from '../api';
