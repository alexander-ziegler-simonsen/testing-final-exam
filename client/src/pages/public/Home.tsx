    ...
    <>
      ...
      <Container bg={"red.300"} marginLeft={"auto"} marginRight={"auto"} width={"auto"}>
        ...
        <Stack gap={12} direction={{
          ...
          <Button margin={3} bg={"green.600"} variant={"surface"}>
            book an appointment
          </Button>
          <Button margin={3} variant={"outline"}>
            explore services
          </Button>

          <HStack alignItems={"center"} justifyContent={"center"} width={"auto"}>
            <Card.Root bg={"transparent"} borderColor={"transparent"} >
              <Card.Body p={2} >
                <Clock color="#26ab57" />
          ...
          <Box boxSize={"6/12"} padding={6}>
            ...
            <Image src="https://cdn.pixabay.com/photo/2016/05/01/21/29/universitatsklinikum-ulm-1366018_1280.jpg" borderRadius={58} />
          </Box>
        </Stack>
