          ...
          <Grid templateColumns={{ base: "1fr", sm: "repeat(1, 1fr)", lg: "repeat(2, 1fr)" }} gap={6}>
            {doctors.map((doctor) => (
              ...
              >
                ...
                <Text color={"blue.600"} fontWeight={"medium"} fontSize={"sm"} mb={1}>
                  {doctor.specialty}
                </Text>
                ...
                <HStack justify={"center"} gap={4} mb={5}>
                  <HStack gap={1}>
                    ...
                    <Text fontSize={"sm"} fontWeight={"semibold"}>{doctor.rating.toFixed(1)}</Text>
                  </HStack>
                ...
                <Button size={"sm"} width={"full"} colorPalette={"green"} bg={"green.600"} color={"white"} _hover={{ bg: "green.700" }}>
                  Book appointment
                </Button>
              </Box>
            ))}
