          ...
          <Center>
            <Box textAlign={"center"} maxW={"2xl"} mb={{ base: 12, md: 16 }}>
              ...
              <Heading as={"h1"} size={{ base: "2xl", md: "3xl" }} mb={4}>
                A hospital built around the patient.
              </Heading>
              <Text fontSize={"lg"} color={"gray.600"}>
                Since 1978, Danish Hospital has grown from a small community clinic into a regional teaching hospital — but our commitment to compassionate, individualized care has never changed.
              </Text>
            </Box>
          </Center>
