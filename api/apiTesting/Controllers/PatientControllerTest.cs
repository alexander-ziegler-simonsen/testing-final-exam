...
// "new PatientController(mock, mock)" test could never actually observe a 401.
// IPatientService and ICprService are swapped for mocks in DI, so no real database is touched.
