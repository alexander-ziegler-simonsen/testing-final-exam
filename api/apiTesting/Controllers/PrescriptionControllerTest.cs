...
// "new PrescriptionController(mock)" test could never actually observe a 401.
// IPrescriptionService is swapped for a mock in DI, so no real database is touched.
